...
export default function AgendaView() {
  ...
  const handleWhatsApp = (phone: string, name: string) => {
    const message = `¡Hola ${name}! Te escribo de Abru Nails 💅 para recordarte tu turno.`;
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-300">
      ...
      <Card className="bg-white p-2 sm:p-6 shadow-sm border border-[var(--rose-200)]">
        {isLoading ? (
          <div className="h-[600px] flex items-center justify-center text-[var(--rose-500)] animate-pulse font-medium">
            Cargando agenda...
          </div>
        ) : (
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            {clients.length === 0 ? (
              ...
              <select name="clientId" required className="block w-full px-4 py-3 border-2 border-[var(--rose-200)] rounded-lg focus:ring-2 focus:ring-[var(--rose-400)] bg-white outline-none">
          ...
          <div>
            ...
            <select name="serviceId" required className="block w-full px-4 py-3 border-2 border-[var(--rose-200)] rounded-lg focus:ring-2 focus:ring-[var(--rose-400)] bg-white outline-none">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="datetime-local" name="date" required className="block w-full px-4 py-3 border-2 border-[var(--rose-200)] rounded-lg focus:ring-2 focus:ring-[var(--rose-400)] bg-white outline-none"/>
            </div>
            <div>
              <Label>Estado</Label>
              <select name="status" className="block w-full px-4 py-3 border-2 border-[var(--rose-200)] rounded-lg focus:ring-2 focus:ring-[var(--rose-400)] bg-white outline-none">
      ...
      >
        {selectedEvent && (
          <div className="space-y-5">
            <div className="flex items-center justify-between pb-4 border-b border-[var(--rose-100)]">
              <h3 className="text-xl font-bold text-[var(--rose-900)]">Información de Cita</h3>
            ...
            <div className="grid gap-4">
              <div className="flex items-center gap-3 text-gray-700">
                <div className="p-2 bg-[var(--rose-50)] rounded-lg text-[var(--rose-600)]"><User className="w-5 h-5"/></div>
                <div>
                  <p className="text-xs text-gray-400 uppercase font-semibold">Clienta</p>
                  <p className="font-medium">{selectedEvent.clientName}</p>
                </div>
              </div>
              
              <div className="flex items-center gap-3 text-gray-700">
                <div className="p-2 bg-[var(--rose-50)] rounded-lg text-[var(--rose-600)]"><Scissors className="w-5 h-5"/></div>
                <div>
            ...
            <div className="flex justify-end gap-3 pt-4 mt-2 border-t border-[var(--rose-100)]">
              <button 
